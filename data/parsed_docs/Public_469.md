**VIETTEL AI RACE** TD004 **QUY ĐỊNH KỸ THUẬT ĐỐI VỚI XE** Lần ban hành: 1 **CHƯA QUA SỬ DỤNG** 
...
**VIETTEL AI RACE** TD004 **QUY ĐỊNH KỸ THUẬT ĐỐI VỚI XE CHƯA QUA SỬ DỤNG** 
...
Đối với hệ thống phanh của cần trục bánh lốp có vận tốc thiết kế lớn 
**VIETTEL AI RACE** TD004 **QUY ĐỊNH KỸ THUẬT ĐỐI VỚI XE CHƯA QUA SỬ DỤNG** 
...
nhất không nhỏ hơn 60 km/h phải thỏa mãn yêu cầu về hệ thống phanh quy định tại mục 2.5 của QCVN 09:2015/BGTVT Quy chuẩn kỹ thuật quốc gia về chất lượng an toàn kỹ thuật và bảo vệ môi trường đối với xe ô tô[(1)] . 

## **1.10 Yêu cầu đối với đường thử phanh** 

Bề mặt đường thử phải cứng, khô, bằng phẳng. 

Đường thử để thử xe tự đổ có khối lượng thử lớn hơn 32000 kg phải đáp ứng với phép thử có độ dốc xuống 8~10% theo hướng di chuyển của xe. 
...
Thử khoảng cách dừng đối với phanh chính và phanh dự phòng (trừ hệ thống phanh thuỷ lực) được tiến hành khi cơ cấu phanh còn nguội. Phải 
**==> picture [38 x 47] intentionally omitted <==**

||**VIETTEL AI RACE**|TD004|
|---|---|---|
||**QUY ĐỊNH KỸ THUẬT ĐỐI VỚI XE**<br>**CHƯA QUA SỬ DỤNG**|Lần ban hành: 1|

tiến hành 2 lần thử khi xe di chuyển theo chiều tiến theo hai hướng ngược nhau. Thời gian giữa 2 lần thử tối thiểu là 10 phút. 
...
|Loại phương tiện||Khoảng cách|Khoảng cách|dừng tối đa|dừng tối đa|
|---|---|---|---|---|---|
|||Phanh chính||Phanh phụ||
|Máy cạp, xe tự đổ khung cứng và xe<br>tự đổ khung khớp nối có khối lượng<br>thử  ≤32 000 kg và máy tự đổ nửa rơ<br>moóc có khối lượng bất kỳ(*)||𝒗𝟐<br>𝟒𝟒<br>+ 𝟎, 𝟏(𝟑𝟐−𝒗)||𝒗𝟐<br>𝟑𝟎<br>+ 𝟎, 𝟏(𝟑𝟐−𝒗)||
|Máy cạp, máy xúc lật khung cứng và<br>máy xúc lật khung khớp nối với khối<br>lượng thử  >32 000 kg|||𝒗𝟐<br>𝟒𝟖−𝟐, 𝟔𝒂||𝒗𝟐<br>𝟑𝟒−𝟐, 𝟔𝒂|
|Xe lu các loại||𝒗𝟐||𝒗𝟐<br>𝟕𝟓<br>+ 𝟎, 𝟒(𝟓+ 𝒗)||
|Các Xe khác, bao gồm các xe kéo rơ<br>móc có tải||𝒗𝟐<br>𝟏𝟔𝟎<br>+ 𝟎, 𝟐(𝟓+ 𝒗)||𝒗𝟐<br>𝟖𝟎<br>+ 𝟎, 𝟒(𝟓+ 𝒗)||
|𝒗là vận tốc thử(km/h)||||||
|𝑎là độdốc kiểm tra(8-10%)||||||
|Chú thích *: Xóa công thức 0,1(32-v) đối với|các|xe có tốc độ lớn hơn||32 km/h||

Khả năng giữ xe đứng yên ngang dốc của hệ thống phanh chính và 
**==> picture [38 x 47] intentionally omitted <==**
...
phanh đỗ đối với XMCD sử dụng bánh xe để di chuyển và XMCD bánh xích cao su có vận tốc lớn hơn 20km/h thỏa mãn yêu cầu như trong Bảng 2. 
**VIETTEL AI RACE** TD004 **QUY ĐỊNH KỸ THUẬT ĐỐI VỚI XE CHƯA QUA SỬ DỤNG** 
...
|Loại phanh|Loại xe|Độ dốc<br>(%)|
|---|---|---|
|Phanh chính|Xe tự đổ có khối lượng thử > 32000 kg|20|
||Xe lu các loại|20|
||Xe tự đổ, sơ mi rơ moóc tự đổ được<br>kết hợp với xe kéo có khối lượng thử ≤<br>32000 kg|25|
||Tất cả các xe khác|25|
|Phanh đỗ|Xe tự đổ, xe cạp đất được kết hợp với<br>xe kéo|15|
||Xe lu các loại|20|
||Sơ mi rơ moóc tự đổ|20|
||Tất cả các xe khác|20|
|Chú ý:<br>1. Khi thử phanh cần ngắt hệ thống truyền lực, động cơ hoạt động ở<br>trạng thái<br>không tải hoặc dừng<br>2. Không áp dụng đối với các xe có hệ thống phanh truyền động thủy<br>tĩnh hoặc<br>tương tự.|||
**VIETTEL AI RACE** 

**==> picture [38 x 47] intentionally omitted <==**

## **QUY ĐỊNH KỸ THUẬT ĐỐI VỚI XE CHƯA QUA SỬ DỤNG** 
